...
function model(; xlist::Vector{Float64}, αs::Float64, Q::Float64, XLL::String,
    ...
    for x in χ_list
        push!(non_singular, non_singular_sigma_χ(χ=x, Q=Q, μ_ini=91.1876, αs_ini=αs, nf=5, order=2))
    end
