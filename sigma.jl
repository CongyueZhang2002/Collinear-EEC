...
# Parallel
function sigma_fast(; Q::Float64, χ_list::Vector{Float64}, μ_ini::Float64, αs_ini::Float64, nf::Int64, XLL::String,
    μH_ratio::Float64=1.0, μJ_ratio::Float64=1.0, νJ_ratio::Float64=1.0, 
    μS_ratio::Float64=1.0, νS_ratio::Float64=1.0, bmax_ratio::Float64=1.0,
    ...
    try
        ...
        function compute_sigma_χ(χ)
            return sigma_χ(Q=Q1, χ=χ, μ_ini=μ_ini1, αs_ini=αs_ini1, nf=nf1, XLL=XLL1,
                            μH_ratio=μH_ratio, μJ_ratio=μJ_ratio, νJ_ratio=νJ_ratio, 
                            μS_ratio=μS_ratio, νS_ratio=νS_ratio, bmax_ratio=bmax_ratio,
                            parameters=parameters,
                            Ω1=Ω1, μ_ren_ratio=μ_ren_ratio)
...
# Check 
function integrated(; Q::Float64, b::Float64, μ_ini::Float64, αs_ini::Float64, nf::Int64, XLL::String,
    μH_ratio::Float64 = 1.0, μJ_ratio::Float64 = 1.0, νJ_ratio::Float64 = 1.0, 
    μS_ratio::Float64 = 1.0, νS_ratio::Float64 = 1.0, bmax_ratio::Float64 = 1.0)

    f = Integrand(b=b, Q=Q, z=1.0, μ_ini=μ_ini, αs_ini=αs_ini, nf=nf, XLL=XLL,
